...
<body class="account-page bg-white">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center flex-wrap">
                                        ...
                                        {{-- <div class="text-center flex-fill">
                                            <a href="javascript:void(0);"
                                                ...
                                                <img class="img-fluid m-1" src="assets/img/icons/apple-logo.svg"
                                                    alt="Apple">
                                            </a>
                                        </div> --}}
                                    </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="9548918c231fbf1f729dd2b3-text/javascript"></script>

    <!-- Feather Icon JS -->
    <script src="assets/js/feather.min.js" type="9548918c231fbf1f729dd2b3-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="9548918c231fbf1f729dd2b3-text/javascript"></script>

    <!-- Custom JS -->
    <script src="assets/js/script.js" type="9548918c231fbf1f729dd2b3-text/javascript"></script>

    {{-- <script src="https://dreamspos.dreamstechnologies.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="9548918c231fbf1f729dd2b3-|49" defer></script> --}}
    {{-- <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" --}}
    {{-- data-cf-beacon='{"rayId":"92e6b65058cf6d16","version":"2025.3.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}'
    crossorigin="anonymous"></script> --}}
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/signin-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Apr 2025 01:39:21 GMT -->
