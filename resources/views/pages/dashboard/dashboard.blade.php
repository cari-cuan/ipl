           ...
           <div class="alert bg-orange-transparent alert-dismissible fade show mb-4">
               <div>
                   <span><i class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product </span> <span
                       class="text-orange fw-semibold"> Apple Iphone 15 is running Low, </span> already below 5
                   Pcs., <a href="javascript:void(0);" class="link-orange text-decoration-underline fw-semibold"
           ...
           <div class="card revenue-widget flex-fill">
               <div class="card-body">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                       <p class="mb-0"><span class="fs-13 fw-bold text-success">+35%</span> vs Last
                           Month</p>
       ...
       <div class="col-xl-3 col-sm-6 col-12 d-flex">
           <div class="card revenue-widget flex-fill">
               <div class="card-body">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                       <p class="mb-0"><span class="fs-13 fw-bold text-success">+41%</span> vs Last
                           Month</p>
       ...
       <div class="col-xl-3 col-sm-6 col-12 d-flex">
           <div class="card revenue-widget flex-fill">
               <div class="card-body">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                       <p class="mb-0"><span class="fs-13 fw-bold text-danger">-20%</span> vs Last
                           Month</p>
                       ...
                       <div class="d-flex align-items-center gap-2">
                           <div class="border p-2 br-8">
                               <p class="d-inline-flex align-items-center mb-1"><i
                                       class="ti ti-circle-filled fs-8 text-primary-300 me-1"></i>Total
                                   Purchase</p>
                               <h4>3K</h4>
                           </div>
                           <div class="border p-2 br-8">
                               <p class="d-inline-flex align-items-center mb-1"><i
                                       class="ti ti-circle-filled fs-8 text-primary me-1"></i>Total Sales
                               </p>
                               <h4>1K</h4>
                           </div>
                       </div>
               ...
               <div class="card-body sell-product">
                   <div class="d-flex align-items-center justify-content-between border-bottom">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Charger Cable -
                                       Lighting</a></h6>
                   ...
                   <div class="d-flex align-items-center justify-content-between border-bottom">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Yves Saint Eau De
                                       Parfum</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>$145</p>
                                   <p>289+ Sales</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between border-bottom">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Apple Airpods
                                       2</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>$458</p>
                                   <p>300+ Sales</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between border-bottom">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Vacuum
                                       Cleaner</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>$139</p>
                                   <p>225+ Sales</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Samsung Galaxy
                                       S21 Fe 5g</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>$898</p>
                                   <p>365+ Sales</p>
       ...
       <div class="col-xxl-4 col-md-6 d-flex">
           <div class="card flex-fill">
               <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                   ...
                   <a href="low-stocks.html" class="fs-13 fw-medium text-decoration-underline">View
                       All</a>
               </div>
               <div class="card-body">
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Vacuum Cleaner
                                       Robot</a></h6>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">KitchenAid Stand
                                       Mixer</a></h6>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Levi's Trucker
                                       Jacket</a></h6>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-0">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Lay's Classic</a>
                               </h6>
               ...
               <div class="card-body">
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Apple Watch
                                       Series 9</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>Electronics</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Gold Bracelet</a>
                               </h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>Fashion</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Parachute Down
                                       Duvet</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>Health</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-4">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">YETI Rambler
                                       Tumbler</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>Sports</p>
                   ...
                   <div class="d-flex align-items-center justify-content-between mb-0">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Osmo Genius
                                       Starter Kit</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p>Lifestyles</p>
       ...
       <div class="col-xl-6 col-sm-12 col-12 d-flex">
           <div class="card flex-fill">
               <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                   ...
                   <a href="online-orders.html" class="fs-13 fw-medium text-decoration-underline">View
                       All</a>
               </div>
               <div class="card-body p-0">
                   <ul class="nav nav-tabs nav-justified transaction-tab">
                       ...
                       <li class="nav-item"><a class="nav-link" href="#quotation" data-bs-toggle="tab">Quotation</a>
                       </li>
                                   ...
                                   <tbody>
                                           ...
                                           <td>
                                               <div class="d-flex align-items-center file-name-icon">
                                                   <a href="javascript:void(0);" class="avatar avatar-md">
                                                       <img src="{{ asset('assets/img/customer/customer16.jpg') }}"
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex align-items-center file-name-icon">
                                                   <a href="javascript:void(0);" class="avatar avatar-md">
                                                       <img src="{{ asset('assets/img/customer/customer17.jpg') }}"
                                                           class="img-fluid" alt="img">
                                                   </a>
                                                   <div class="ms-2">
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex align-items-center file-name-icon">
                                                   <a href="javascript:void(0);" class="avatar avatar-md">
                                                       <img src="{{ asset('assets/img/customer/customer18.jpg') }}"
                                                           class="img-fluid" alt="img">
                                                   </a>
                                                   <div class="ms-2">
                                           ...
                                           <td><span
                                                   class="badge badge-pink badge-xs d-inline-flex align-items-center"><i
                                                       class="ti ti-circle-filled fs-5 me-1"></i>Draft</span>
                                           </td>
                                           <td class="fs-16 fw-bold text-gray-9">$4,560</td>
                                       </tr>
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex align-items-center file-name-icon">
                                                   <a href="javascript:void(0);" class="avatar avatar-md">
                                                       <img src="{{ asset('assets/img/customer/customer15.jpg') }}"
                                                           class="img-fluid" alt="img">
                                                   </a>
                                                   <div class="ms-2">
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex align-items-center file-name-icon">
                                                   <a href="javascript:void(0);" class="avatar avatar-md">
                                                       <img src="{{ asset('assets/img/customer/customer13.jpg') }}"
                                                           class="img-fluid" alt="img">
                                                   </a>
                                                   <div class="ms-2">
                               ...
                               <table class="table table-borderless custom-table">
                                   ...
                                   <tbody>
                                       ...
                                       <tr>
                                           <td>26 May 2025</td>
                                           <td>
                                               <a href="javascript:void(0);" class="fw-semibold">A-Z
                                                   Store s</a>
                                           </td>
                                           <td><span
                                                   class="badge badge-success badge-xs d-inline-flex align-items-center"><i
       ...
       <div class="col-xxl-4 col-md-6 d-flex">
           <div class="card flex-fill">
               <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                   ...
                   <a href="customers.html" class="fs-13 fw-medium text-decoration-underline">View
                       All</a>
               </div>
               <div class="card-body">
                   <div
                       ...
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Carlos
                                       Curran</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p class="d-inline-flex align-items-center"><i class="ti ti-map-pin me-1"></i>USA
                                   </p>
                                   <p>24 Orders</p>
                               </div>
                           </div>
                   ...
                   <div
                       ...
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Stan
                                       Gaunter</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p class="d-inline-flex align-items-center"><i class="ti ti-map-pin me-1"></i>UAE
                                   </p>
                                   <p>22 Orders</p>
                               </div>
                           </div>
                   ...
                   <div
                       ...
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Richard
                                       Wilson</a></h6>
                               <div class="d-flex align-items-center item-list">
                   ...
                   <div
                       ...
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Mary
                                       Bronson</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p class="d-inline-flex align-items-center"><i
                   ...
                   <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                               <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Annie
                                       Tremblay</a></h6>
                               <div class="d-flex align-items-center item-list">
                                   <p class="d-inline-flex align-items-center"><i
