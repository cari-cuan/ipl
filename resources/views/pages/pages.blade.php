@extends('layouts.customers.layout')
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <a href="javscript:void(0);"
                                class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                <span class="d-inline-flex align-items-center">
                                    <img src="assets/img/icons/liked-page-02.svg" class="me-2" alt="Img">UI/UX
                                    Designs
                                </span>
                                <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                            </a>
                            ...
                            <div>
                                <div class="more-menu-3">
                                    <a href="javscript:void(0);"
                                        class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                        <span class="d-inline-flex align-items-center">
                                            <img src="assets/img/icons/liked-page-04.svg" class="me-2" alt="Img">I Am
                                            Techie
                                        </span>
                                        <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                    </a>
        ...
        <div class="col-xl-6">
            <div>
                ...
                <div class="card">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);"
                                    class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img
                                        src="assets/img/users/user-03.jpg" alt="Img"></a>
                                <div>
                                    <h5 class="mb-1"><a href="javascript:void(0);">Richard Smith <i
                                                class="ti ti-circle-check-filled text-success"></i></a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ms-3 me-1">
                                    <button
                                        class="btn btn-icon dropdown-toggle bg-transparent d-flex align-items-center text-dark border-0 p-0 btn-sm"
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="d-inline-flex align-items-center show"
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <p class="text-dark fw-medium">"Believe in yourself and all that you are. Know
                                that there is
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <p class="text-dark fw-medium">
                                ...
                                <a href="javascript:void(0);" class="text-info link-hover">#HealthTips
                                </a>
                        ...
                        <div class="card shadow-none mb-3">
                            <div class="card-img card-img-hover rounded-0">
                                <a href="javascript:void(0);" class="rounded-top"><img
                                        src="assets/img/social/social-feed-02.jpg" class="rounded-top"
                                        alt="Img"></a>
                            </div>
                            <div class="card-body p-2">
                                <h6 class="mb-1 text-truncate"><a href="javascript:void(0);">Drinking
                                        water boosts skin health and beauty. Stay hydrated!💧</a></h6>
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <p class="text-dark fw-medium">
                                ...
                                special discount.
                                <a href="javascript:void(0);" class="text-info link-hover">#NewRelease
                                </a>
                                <a href="javascript:void(0);" class="text-info link-hover">
                                    #Innovation</a>
                                🎉
                        ...
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div class="bg-light rounded flex-fill p-2">
                                ...
                                <p class="mb-1">Congratulations on the launch! I've been eagerly waiting
                                    for this
                        ...
                        <div>
                            ...
                            <div class="view-all text-center mb-3">
                                <a href="javascript:void(0);" class="viewall-button text-primary fw-medium"><span>View All
                                        200
                                        Comments</span><i class="fa fa-chevron-down fs-10 ms-2"></i></a>
                            </div>
                        </div>
                        <div class="d-flex align-items-start">
                            <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="assets/img/users/user-11.jpg"
                                    alt="Img"></span>
                            <input type="text" class="form-control" placeholder="Enter Comments">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills border d-flex p-2 rounded mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link btn active w-100" data-bs-toggle="pill" data-bs-target="#pills-home"
                                type="button" role="tab" aria-selected="true">
                                General
                            </button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link btn w-100" data-bs-toggle="pill" data-bs-target="#pills-profile"
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                            <img src="assets/img/users/user-18.jpg" alt="Img">
                                        </a>
                                        <div>
                                            <h6 class="d-inline-flex align-items-center fw-medium mb-1">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="bg-light rounded p-2 mb-2">
                        ...
                        <p class="text-dark fw-medium"><a href="javascript:void(0);">Retail investor
                                party continues even as</a></p>
                    </div>
                    <div class="bg-light rounded p-2 mb-2">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <a href="javascript:void(0);" class="d-flex align-items-center">
                        ...
                        <p class="text-dark fw-medium"><a href="javascript:void(0);">Ipad Air (2020) vs
                    ...
                    <div class="bg-light rounded p-2 mb-2">
                        ...
                        <p class="text-dark fw-medium"><a href="javascript:void(0);">Beyond capital
                                gains tax! Top 50 stock</a></p>
                    </div>
                    <div class="bg-light rounded p-2">
                        ...
                        <p class="text-dark fw-medium"><a href="javascript:void(0);">Sony Just Destroyed
                                the Competition</a></p>
                    </div>
                    <div class="mt-3">
                        <a href="javascript:void(0);" class="btn btn-outline-light w-100 border">View
                            All <i class="ti ti-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-img card-img-hover mb-3">
                        <a href="javascript:void(0);" class="rounded"><img src="assets/img/social/social-feed-04.jpg"
                                class="rounded" alt="Img"></a>
                    </div>
                    <h6 class="text-center"><a href="javascript:void(0);">Enjoy Unlimited Access on a
                            small price monthly.</a></h6>
                    <div class="mt-3">
                        <a href="javascript:void(0);" class="btn btn-outline-light w-100 border">Upgrade
                            Now <i class="ti ti-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
