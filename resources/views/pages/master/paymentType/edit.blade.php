...
@section('content')
    <div class="content">
        ...
        <form action="{{ route('payment-types.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3 form-check mt-4">
                                        <input type="checkbox" name="is_recurring" value="1" class="form-check-input" id="is_recurring"
                                            {{ old('is_recurring', $data->is_recurring) ? 'checked' : '' }}>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" class="form-control" rows="3" required>{{ old('description', $data->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
