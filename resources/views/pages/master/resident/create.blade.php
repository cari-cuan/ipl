...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('resident.index') }}" class="btn btn-secondary"><i data-feather="arrow-left"
            ...
            <div class="accordions-items-seperate" id="accordionExample">
                <div class="accordion-item border mb-4">
                    <h2 class="accordion-header" id="headingOne">
                        <div class="accordion-button bg-white" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            aria-controls="collapseOne">
                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                <h5 class="d-inline-flex align-items-center"><i
                                        class="ti ti-users text-primary me-2"></i><span>General Information</span></h5>
                            </div>
                        </div>
                    </h2>
                        ...
                        <div class="accordion-body border-top">
                            <div class="new-employee-field">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Residential Area <span
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">KTP Number<span
                                                    class="text-danger ms-1">*</span></label>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" name="is_owner" value="1" class="form-check-input"
                                                id="is_owner"
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="join_date" class="form-control"
                                                value="{{ old('join_date', isset($resident) ? $resident->join_date : '') }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
