...
class HousingUnitController extends Controller
{
    public function datatables(Request $request): JsonResponse
    {
        ...
        // Query the model
        $query = HousingUnitModel::with(['residentialArea', 'resident']);
        ...
        $recordsTotal = HousingUnitModel::count();
        ...
        foreach ($lists as $list) {
            ...
            $row->unit_code = $list->unit_code;
            $row->block = $list->block;
            $row->floor_area = $list->floor_area;
